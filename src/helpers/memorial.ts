 ...
 *
 * Estrutura alinhada ao NT.00020.EQTL-06 Anexo III REV 06 (12/2025):
 *   Seções 1–11: skeleton oficial (Objetivo … Anexos) — numeração e títulos idênticos ao modelo CEEE
 *   Seções 12–16: complementares Instalight (estimativa/impacto, estrutura, comissionamento, manutenção, NR-10)
 *
 * Marcadores IA (substituídos pela IA ou pelo modo básico):
 *   [[[IA_NARRATIVA_SEC1]]]  — seção 1 Objetivo
 *   [[[IA_NARRATIVA_SEC10]]] — seção 12 Impacto Ambiental
 *   [[[IA_NARRATIVA_SEC7]]]  — seção 13 Estrutura de Fixação
 *   [[[IA_NARRATIVA_SEC12]]] — seção 14 Comissionamento (introdução)
 */
...
6.  DIMENSIONAMENTO DO GERADOR
    6.1  Características Técnicas dos Módulos FV
    6.2  Topologia das Strings
    6.3  Queda de Tensão em Corrente Contínua
7.  DIMENSIONAMENTO DO INVERSOR (SE HOUVER)
8.  DIMENSIONAMENTO DA PROTEÇÃO
    8.1  Fusíveis
    8.2  Disjuntores
    8.3  Dispositivo de Seccionamento Visível
    8.4  DPS
    8.5  Aterramento
    8.6  Requisitos de Proteção
9.  DIMENSIONAMENTO DOS CABOS
10. PLACA DE ADVERTÊNCIA
11. ANEXOS
--- SEÇÕES COMPLEMENTARES (INSTALIGHT) ---
12. ESTIMATIVA DE GERAÇÃO E IMPACTO AMBIENTAL
13. ESTRUTURA DE FIXAÇÃO
14. COMISSIONAMENTO
15. EXPLORAÇÃO E MANUTENÇÃO
16. NOTAS DE SEGURANÇA — NR-10
    RESPONSÁVEL TÉCNICO
...
8.3 Dispositivo de Seccionamento Visível (DSV)
...
8.4 DPS — Proteção CC (String Box)
...
11. ANEXOS
------------------------------------------------------------
Documentos que acompanham esta solicitação de orçamento de conexão (NT.00020.EQTL-06):

• Formulário de Solicitação de Orçamento de Conexão (Anexo I).
• Documento de responsabilidade técnica (ART/TRT — projeto e execução) do conselho competente.
• Diagrama unifilar contemplando geração, inversor, cargas, proteção e medição.
• Diagrama de blocos contemplando geração, inversor, cargas, proteção e medição.
• Relatório de ensaio, em língua portuguesa, atestando a conformidade de todos os
  conversores de potência para a tensão nominal de conexão com a rede (quando houver inversor).
• Dados de registro do inversor (certificado/registro INMETRO).
• Lista de rateio dos créditos (se aplicável — Autoconsumo Remoto, Geração Compartilhada ou EMUC).
• Cópia de instrumento jurídico de solidariedade (se aplicável).
• Documento de reconhecimento pela ANEEL (somente para cogeração qualificada).
...
14.1 Inspeção Prévia — Sistema CC
...
14.2 Inspeção Prévia — Sistema CA
...
14.3.5 Resistência de Isolamento das Strings
...
14.3.6 Inspeção Termográfica (recomendada)
...
15. EXPLORAÇÃO E MANUTENÇÃO
------------------------------------------------------------
15.1 Periodicidade de Verificações
...
15.2 Operações em Caso de Falha
...
15.3 Procedimento de Desligamento de Emergência
...
15.4 Manutenção dos Módulos FV
